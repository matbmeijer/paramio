...
def update_config(element: Any, **update_keys: Dict[str, str]) -> Any:
    """
    ...
    Args:
      ...
      replacements (Dict): Key-Values to update, defining the value as the new value to be
    ...
    if isinstance(element, str):
        return element.format_map(SaveFormatting(**element))
